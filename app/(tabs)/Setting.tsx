...
const Setting = () => {
  ...
  const accountSettings: SettingOption[] = [
    {
      ...
      type: 'navigation',
      onPress: () => Alert.alert('Thông tin cá nhân', 'Chức năng đang phát triển'),
    },
    {
      id: 'security',
      title: 'Bảo mật',
  ...
  const supportSettings: SettingOption[] = [
    ...
    },
    {
      ...
      icon: '📞',
      type: 'navigation',
      onPress: () => Alert.alert('Liên hệ', 'Email: yteschool@edu.vn\nHotline: 0123-456-789'),
    },
    {
      id: 'about',
      title: 'Về ứng dụng',
  ...
  const renderSettingItem = (setting: SettingOption) => (
    ...
    >
      <View style={styles.settingLeft}>
        <View style={[styles.settingIcon, setting.color && { backgroundColor: setting.color + '20' }]}>
          <Text style={[styles.settingIconText, setting.color && { color: setting.color }]}>
            {setting.icon}
          </Text>
        </View>
        <View style={styles.settingContent}>
          <Text style={[styles.settingTitle, setting.danger && styles.dangerText]}>
            {setting.title}
          </Text>
      ...
      {setting.type === 'toggle' && setting.onToggle && (
        <Switch
          ...
          thumbColor={setting.value ? (setting.color || MedicalColors.primary) : '#f4f3f4'}
        />
      )}
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
          ...
          <ScrollView style={styles.modalContent}>
            ...
            <View style={styles.aboutDescription}>
              <Text style={styles.aboutText}>
                Hệ thống quản lý y tế trường học toàn diện, giúp kết nối phụ huynh, 
                cán bộ y tế và ban quản lý trong việc chăm sóc sức khỏe học sinh.
              </Text>
              
              <Text style={styles.featureTitle}>✨ Tính năng chính:</Text>
              <Text style={styles.featureItem}>• Theo dõi sức khỏe học sinh</Text>
          ...
          <ScrollView style={styles.modalContent}>
            <View style={styles.privacySection}>
              ...
              <Text style={styles.privacyText}>
                ...
                • Cơ quan y tế khi có yêu cầu hợp pháp{'\n'}
                • Không bán hoặc cho thuê thông tin của bạn
              </Text>
            </View>
          </ScrollView>
        </View>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>{MedicalIcons.school} School Medicine v1.0.0</Text>
