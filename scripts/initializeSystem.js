// Initialize Complete School Medical System
// Khởi tạo từ Firebase config - All in One
// Run: node scripts/initializeSystem.js

import { createUserWithEmailAndPassword, updateProfile } from 'firebase/auth';
import { doc, setDoc, Timestamp, writeBatch } from 'firebase/firestore';
import { auth, db } from '../constants/firebaseConfig.js';
...
📡 Using Firebase config from constants/firebaseConfig.js
🎯 Project: mma-297bc

Will create:
✅ 3 Admin accounts (admin, director, nurse)
✅ 300 Students with complete medical records  
✅ 12 Grades (10A1-12B2, 25 students each)
✅ Medical data categories
✅ System configuration

Ready to initialize? Uncomment the last line!
`);

// Uncomment để chạy initialization
// initializeSystem(); 